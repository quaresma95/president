...
class view_president_president extends game_view {
    ...
    function build_page ($viewArgs) {
        ...
        $variant_data = [
            ...
            ["state_name" => "unskippable_23", "label" => "UNSKIPPABLE_23", "variant" => clienttranslate('Unskippable 2/3')],
            ...
            ["state_name" => "permanent_pass", "label" => "PERMANENT_PASS", "variant" => clienttranslate('Permanent pass')],
        ];
